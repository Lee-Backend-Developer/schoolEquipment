...
public record ClassTimeUpdate(
    ...
    public static class ClassTimeUpdateBuilder {
        ...
        public ClassTimeUpdateBuilder dayOfWeek(DayOfWeekEnum dayOfWeekEnum) {
        ...
        public ClassTimeUpdate build() {
            return new ClassTimeUpdate(this.oldClassname, this.newClassname, this.dayOfWeekEnum, this.oneTime, this.twoTime, this.threeTime, this.fourTime, this.fiveTime, this.sixTime, this.sevenTime, this.eightTime, this.nineTime, this.tenTime);
        }
