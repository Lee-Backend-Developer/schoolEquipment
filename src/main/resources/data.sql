...
--     화요일
insert into classtimetable (class_name, day_of_week, ONE_TIME, TWO_TIME, THREE_TIME)
values ('스튜디오제작기초', 'Tuesday', true, true, true);

insert into classtimetable (class_name, day_of_week, ONE_TIME, TWO_TIME, THREE_TIME, FOUR_TIME, FIVE_TIME)
...
--     목요일
insert into classtimetable (class_name, day_of_week, ONE_TIME, TWO_TIME, THREE_TIME, FOUR_TIME, FIVE_TIME, SIX_TIME)
